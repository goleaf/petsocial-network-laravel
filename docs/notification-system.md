...
- Pet-level notification coverage exists across `tests/Feature/PetNotificationsAccessTest.php`, `tests/Unit/PetNotificationsComponentTest.php`, `tests/Livewire/PetNotificationsLivewireTest.php`, `tests/Filament/PetNotificationsFilamentTest.php`, and `tests/Http/PetNotificationsHttpTest.php`; update these suites whenever the Livewire component changes to keep every interface in sync.
