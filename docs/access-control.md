...
- **Automated coverage** – the friend finder import, search, and request flows are now protected by unit, feature, Livewire, HTTP, and Filament integration tests under `tests/Unit/Common/Friend/FinderCsvImportTest.php`, `tests/Feature/FriendFinderFeatureTest.php`, `tests/Livewire/Common/Friend/FinderComponentTest.php`, `tests/Http/FriendFinderHttpTest.php`, and `tests/Filament/Common/Friend/FinderFilamentIntegrationTest.php`.
