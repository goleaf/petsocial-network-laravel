...
- The group management dashboard now exposes cached category summaries so moderators can quickly review groups by topic before applying membership decisions or moderation tools.
