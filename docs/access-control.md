...
- Group moderators and admins can triage join requests, removals, and bans via the `/groups/{group}/moderation` Livewire panel which centralises approval, denial, and reinstatement actions with audit-friendly feedback.
