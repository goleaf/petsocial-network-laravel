...
return [
    ...
    'join_community' => 'Join Our Pet Community',
    'register_subtitle' => 'Create an account for you and your furry friends',
    'name_placeholder' => 'Your full name',
    'password_requirements' => 'Must be at least 8 characters with mixed case, numbers, and symbols',
    'agree_terms_and_conditions' => 'I agree to the <a href=":terms_url" class="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300">Terms of Service</a> and <a href=":privacy_url" class="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300">Privacy Policy</a>',
