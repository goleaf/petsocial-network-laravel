...
return [
    ...
    'analytics_filters_title' => 'Filtruokite analitiką pagal datų intervalą',
    'analytics_filters_description' => 'Pakoreguokite ataskaitos laikotarpį ir atsisiųskite suasmenintą analitikos ataskaitą.',
    'analytics_filters_start' => 'Pradžios data',
    'analytics_filters_end' => 'Pabaigos data',
    'analytics_export_button' => 'Eksportuoti ataskaitą',
    'analytics_total_posts' => 'Paskelbtos žinutės',
    'analytics_total_comments' => 'Parašyti komentarai',
    'analytics_reactions_made' => 'Paliktos reakcijos',
    ...
    'analytics_top_post_comments' => 'Komentarai',
    'analytics_top_post_shares' => 'Pasidalijimai',
    'analytics_top_post_total_engagement' => 'Bendras įsitraukimas',
    'analytics_activity_patterns_title' => 'Aktyvumo modeliai',
    'analytics_activity_patterns_description' => 'Sužinokite, kada rašote, komentuojate, reaguojate ir dalijatės.',
    'analytics_activity_weekdays' => 'Aktyvumas pagal savaitės dieną',
    'analytics_activity_hours' => 'Aktyvumas pagal valandas',
    'analytics_activity_peak' => 'Didžiausias aktyvumas apie :time.',
    'analytics_behavior_title' => 'Elgsenos analizė',
    'analytics_behavior_description' => 'Santykiai parodo, kaip dalyvaujate bendruomenėje per pasirinktą laikotarpį.',
    'analytics_behavior_avg_posts_per_day' => 'Vidutiniškai įrašų per aktyvią dieną',
    'analytics_behavior_reactions_per_post' => 'Paliktų reakcijų vienam įrašui',
    'analytics_behavior_comments_per_post' => 'Komentarų vienam įrašui',
    'analytics_behavior_received_per_post' => 'Gautų reakcijų vienam įrašui',
    'analytics_behavior_shares_per_post' => 'Pasidalijimų vienam įrašui',
    'analytics_growth_title' => 'Augimo stebėjimas',
    'analytics_growth_description' => 'Mėnesinis draugų ir sekėjų augimas rodo auditorijos pulsą.',
    'analytics_growth_new_friends' => 'Nauji draugai',
    'analytics_growth_new_followers' => 'Nauji sekėjai',
    'analytics_growth_empty' => 'Šiam laikotarpiui dar neužfiksuota augimo veiklos.',
    'analytics_report_summary_title' => 'Ataskaitos santrauka',
    'analytics_report_summary_description' => 'Peržiūrėkite eksportuojamus rodiklius prieš atsisiųsdami CSV.',
    'analytics_report_summary_hint' => 'Eksportai apima visus aukščiau pateiktus rodiklius ir laikosi pasirinkto intervalo.',
    'analytics_report_summary_metric_posts' => 'Paskelbtos žinutės',
    'analytics_report_summary_metric_comments' => 'Parašyti komentarai',
    'analytics_report_summary_metric_reactions_made' => 'Paliktos reakcijos',
    'analytics_report_summary_metric_reactions_received' => 'Gautos reakcijos',
    'analytics_report_summary_metric_shares_received' => 'Pasidalijimai',
    'analytics_report_summary_metric_date_range_days' => 'Dienų intervale',
    'analytics_report_summary_metric_top_post_reactions' => 'Daugiausiai reakcijų turintis įrašas',
