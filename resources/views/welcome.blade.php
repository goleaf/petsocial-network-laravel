...
<head>
    ...
    <title>{{ __('common.pets_social_network') }}</title>
...
<body class="antialiased bg-gradient-to-b from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-indigo-950">
    <div class="relative min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 mb-8 md:mb-0">
                        <h1 class="text-4xl sm:text-5xl font-bold text-white mb-4">{{ __('common.welcome_message') }}</h1>
                        <p class="text-xl text-indigo-100 mb-8">{{ __('common.welcome_description') }}</p>
                        <div class="flex space-x-4">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white">{{ __('common.why_join_us') }}</h2>
                    <p class="mt-4 text-xl text-gray-600 dark:text-gray-300">{{ __('common.join_benefits') }}</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <div class="p-8">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">{{ __('common.feature_pets') }}</h3>
                            <p class="text-gray-600 dark:text-gray-300">{{ __('common.feature_pets_description') }}</p>
                        </div>
                    </div>
                    <!-- Feature 2 -->
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <div class="p-8">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">{{ __('common.feature_community') }}</h3>
                            <p class="text-gray-600 dark:text-gray-300">{{ __('common.feature_community_description') }}</p>
                        </div>
                    </div>
                    <!-- Feature 3 -->
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <div class="p-8">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">{{ __('common.feature_events') }}</h3>
                            <p class="text-gray-600 dark:text-gray-300">{{ __('common.feature_events_description') }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="py-12 bg-indigo-50 dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white">{{ __('common.testimonials') }}</h2>
                    <p class="mt-4 text-xl text-gray-600 dark:text-gray-300">{{ __('common.testimonials_description') }}</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('common.testimonial_name_1') }}</h4>
                                <p class="text-gray-600 dark:text-gray-400">{{ __('common.testimonial_pet_1') }}</p>
                            </div>
                        </div>
                        <p class="text-gray-600 dark:text-gray-300">{{ __('common.testimonial_text_1') }}</p>
                    </div>
                    <!-- Testimonial 2 -->
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('common.testimonial_name_2') }}</h4>
                                <p class="text-gray-600 dark:text-gray-400">{{ __('common.testimonial_pet_2') }}</p>
                            </div>
                        </div>
                        <p class="text-gray-600 dark:text-gray-300">{{ __('common.testimonial_text_2') }}</p>
                    </div>
                    <!-- Testimonial 3 -->
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('common.testimonial_name_3') }}</h4>
                                <p class="text-gray-600 dark:text-gray-400">{{ __('common.testimonial_pet_3') }}</p>
                            </div>
                        </div>
                        <p class="text-gray-600 dark:text-gray-300">{{ __('common.testimonial_text_3') }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="py-12 bg-indigo-600 dark:bg-indigo-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl font-bold text-white mb-4">{{ __('common.ready_to_join') }}</h2>
                <p class="text-xl text-indigo-100 mb-8">{{ __('common.join_today_message') }}</p>
        ...
        <footer class="bg-white dark:bg-gray-800 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-8 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between">
                    <p class="text-gray-600 dark:text-gray-300 mb-4 md:mb-0">© {{ date('Y') }} {{ __('common.pets_social_network') }}. {{ __('common.all_rights_reserved') }}</p>
                    <div class="flex flex-wrap space-x-6">
                        <a href="#" class="text-gray-600 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400">{{ __('common.privacy_policy') }}</a>
                        <a href="#" class="text-gray-600 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400">{{ __('common.terms_of_service') }}</a>
                        <a href="#" class="text-gray-600 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400">{{ __('common.contact_us') }}</a>
                    </div>
                </div>
            </div>
        </footer>
