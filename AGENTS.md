...
- Friend finder behaviours now have comprehensive tests (unit, feature, Livewire, HTTP, and Filament) covering imports, search filtering, and request dispatch under the `tests/*/Common/Friend` directories—keep them updated when adjusting `App\Http\Livewire\Common\Friend\Finder`.
