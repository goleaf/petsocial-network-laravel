...
- Dedicated tests now cover the pet notifications Livewire component across `tests/Feature`, `tests/Unit`, `tests/Livewire`, `tests/Filament`, and `tests/Http`; keep these suites aligned with component updates to preserve coverage.
